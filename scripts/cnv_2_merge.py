    ...
    try:
        ...
        for cbio_tum_id in file_meta_dict[cbio_dx]:
            ...
            if manifest is not None:
                ploidy = get_ploidy(args.info_dir + "/" + manifest.loc[kf_bs_id]['File_Name'])
...
parser.add_argument('-i', '--info_dir', action='store', dest='info_dir', help='If info files available, provide here')
