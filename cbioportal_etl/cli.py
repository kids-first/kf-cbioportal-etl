...
def main():
    ...
    common_args.add_argument("-sc", "--study-config", required=False, help="JSON file generated from Step 1 or path to custom JSON (automatically set when applicable)")
    ...
    common_args.add_argument("-m", "--manifest", default="cbio_file_name_id.txt", help="Manifest file (automatically set when applicable)")
    ...
    common_args.add_argument("-ad", "--add-data", action="store_true", dest="add_data", help="Flag to indicate add_data mode (automatically set when applicable)")
